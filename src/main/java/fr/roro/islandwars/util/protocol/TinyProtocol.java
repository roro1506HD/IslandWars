package fr.roro.islandwars.util.protocol;

import com.google.common.collect.Lists;
import com.google.common.collect.MapMaker;
import com.mojang.authlib.GameProfile;
import fr.roro.islandwars.util.protocol.Reflection.FieldAccessor;
import fr.roro.islandwars.util.protocol.Reflection.MethodInvoker;
...
public abstract class TinyProtocol {
     ...
     *
     * @param player - the receiving player, NULL for early login/status packets.
     ...
     *
     * @param player - the player that sent the packet, NULL for early login/status packets.
    ...
    public final void close() {
        if (!closed) {
            ...
            // Remove our handlers
            this.plugin.getServer().getOnlinePlayers().forEach(this::uninjectPlayer);
